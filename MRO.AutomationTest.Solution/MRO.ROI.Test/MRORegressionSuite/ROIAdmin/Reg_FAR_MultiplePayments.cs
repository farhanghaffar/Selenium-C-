...
{
    [TestClass]
    public class RoiAdminFARMultiplePayment : ROITestBase
    {

        //string reqID974 = null;
        static string reqIDDev = null;
        static string reqIDRon = null;
        public RoiAdminFARMultiplePayment() : base(ROITestArea.ROIAdmin)
        {
        ...
        public void Reg_FAR_MultiplePayment(string loginOverride)
        {
            try
            {
