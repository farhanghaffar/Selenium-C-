...
{
    [TestClass]
    public class RoiAdminTestFar1 : ROITestBase
    {
        public RoiAdminTestFar1() : base(ROITestArea.ROIAdmin)
        {
        ...
        //public void Reg_FarRates_3_4_MroCreateNew_Request(string loginOverride)
        //{
        //    try
        //    {
        ...
        //        Driver.Wait(TimeSpan.FromSeconds(5));
        //        //Driver.Instance.Value.FindElement(By.Id("mrocontent_cmdCreateInvoice")).Click();
        ...
        //        //Driver.logger.Info("Adjusted Blaance: " + L1AdjustedBal);
        //        ////23627099
