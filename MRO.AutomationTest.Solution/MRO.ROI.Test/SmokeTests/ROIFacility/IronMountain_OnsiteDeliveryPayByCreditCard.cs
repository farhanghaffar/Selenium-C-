...
{
    [TestClass]
    public class Iron_Mountain_OnSiteDeliveryPayByCreditCard : ROITestBase
    {
        public Iron_Mountain_OnSiteDeliveryPayByCreditCard() : base(ROITestArea.IronMountainROIFacility)
        {
        }
        ...
        public void Reg_IronMountain_OnsiteDelivery_PayByCreditCard()
        {
            try
            {
