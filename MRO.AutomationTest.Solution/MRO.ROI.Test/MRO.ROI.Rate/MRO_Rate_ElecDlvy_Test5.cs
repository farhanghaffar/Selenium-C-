...
namespace MRO.ROI.Test
{
...

    {
        ...
        public class RoiAdminTest : ROITestBase
        {
            ...
            public void MRO_Rate_ElecDlvy_Test5()
            {
                try
                {
                    Driver.logger = Driver.extent.CreateTest("Electronic_Delivery_RequestID_23625040");
                    ...
                    ROIAdminFacalitiesListPage.roilookupidadmin("23625040");
                    Driver.logger.Info("Testing Rate for Request ID: 23625040");
