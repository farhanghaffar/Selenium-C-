...
namespace MRO.ROI.Test
{
...

    {
        ...
        public class RoiAdminTest : ROITestBase
        {
            ...
            public void MRO_Rate_PhyDlvy_Test4()
            {
                try
                {
                    Driver.logger = Driver.extent.CreateTest("Physical_Delivery_RequestID_23625038");
                    ...
                    ROIAdminFacalitiesListPage.roilookupidadmin("23625038");
                    Driver.logger.Info("Testing Rate for Request ID: 23625038");
