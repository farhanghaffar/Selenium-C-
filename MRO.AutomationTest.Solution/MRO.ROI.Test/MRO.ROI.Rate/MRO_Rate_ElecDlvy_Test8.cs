...
namespace MRO.ROI.Test
{
...

    {
        ...
        public class RoiAdminTest : ROITestBase
        {
            ...
            public void MRO_Rate_ElecDlvy_Test8()
            {
                try
                {
                    Driver.logger = Driver.extent.CreateTest("Electronic_Delivery_RequestID_23625044");
                    ...
                    ROIAdminFacalitiesListPage.roilookupidadmin("23625044");
                    Driver.logger.Info("Testing Rate for Request ID: 23625044");
