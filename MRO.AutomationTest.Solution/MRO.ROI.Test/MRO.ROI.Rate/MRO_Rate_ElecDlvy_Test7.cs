...
namespace MRO.ROI.Test
{
...

    {
        ...
        public class RoiAdminTest : ROITestBase
        {
            ...
            public void MRO_Rate_ElecDlvy_Test7()
            {
                try
                {
                    Driver.logger = Driver.extent.CreateTest("Electronic_Delivery_RequestID_23625042");
                    ...
                    ROIAdminFacalitiesListPage.roilookupidadmin("23625042");
                    Driver.logger.Info("Testing Rate for Request ID: 23625042");
