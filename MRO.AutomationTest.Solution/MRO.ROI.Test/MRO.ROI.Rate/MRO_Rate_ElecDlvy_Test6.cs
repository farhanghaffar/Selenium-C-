...
namespace MRO.ROI.Test
{
...

    {
        ...
        public class RoiAdminTest : ROITestBase
        {
            ...
            public void MRO_Rate_ElecDlvy_Test6()
            {
                try
                {
                    Driver.logger = Driver.extent.CreateTest("Electronic_Delivery_RequestID_23625041");
                    ...
                    ROIAdminFacalitiesListPage.roilookupidadmin("23625041");
                    Driver.logger.Info("Testing Rate for Request ID: 23625041");
